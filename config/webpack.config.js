...
// PNNL has made this function async to support loading the ES module remark-gfm
// using `await import('remark-gfm')` on the next line.
module.exports = async function (webpackEnv) {
    ...
    return {
        ...
        optimization: {
            // FIXME: set to false because we were getting a missing variable error
        ...
        module: {
            ...
            rules: [
                ...
                shouldUseSourceMap && {
                    enforce: 'pre',
                    exclude: [/@babel(?:\/|\\{1,2})runtime/, /html2pdf\.js/],
                ...
                },
                {
                    ...
                    oneOf: [
                        ...
                        // Added by PNNL to support MDX
                        // See https://github.com/mdx-js/mdx/tree/main/packages/loader and  https://mdxjs.com/packages/react/
                        {
                            test: /.mdx?$/,
                            use: [
                                {
