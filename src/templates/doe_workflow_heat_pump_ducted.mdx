<Tabs>
    <Tab eventKey="assessment" title="Assessment">
        ...
        <PhotoInput id="existing_heating_appliance_photo" label="Existing Heating Appliance - Photo">
           ...
           Examples of heating appliances: gas furnace, oil furnace, gas boiler, oil boiler, gas wall heater,
           electric wall heater, electric baseboard, wood stove, pellet stove, etc.
        </PhotoInput>
        ...
        <ShowOrHide visible={props.data?.no_cooling_appliance?.length === 0}>
            <PhotoInput id="existing_cooling_appliance_photo" label="Existing Cooling Appliance – Photo">
                ...
                Examples of cooling appliances: central air conditioner,
                window air conditioner, wall air conditioner, evaporative cooler, old heat pump.
            </PhotoInput>
    ...
    <Tab eventKey="report" title="Report">
        ...
        <div className="pdf-wrapper">
            ...
            <ShowOrHide visible={props.data?.no_cooling_appliance?.length === 0}>
                ...
                <Photo id="existing_cooling_appliance_name_plate_photo"
                    label="Existing Cooling Appliance Name Plate – Photo "
                    required>
                    Photo of the existing cooling appliance’s nameplate
                </Photo>
            ...
            <Photo id="pre_upgrade_air_flow_test_results_photo" label="Pre-Upgrade Airflow Results – Photo" required>
                Photo of the manometer CFM or screenshot of the instrument app or the manometer and fan curve chart/table.
            </Photo>
            {
