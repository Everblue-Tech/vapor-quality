<Tabs>
    ...
    <Tab eventKey="planning" title="Planning">
        ...
        Select the equipment based on the ASHRAE heating and cooling design conditions, Manual J load calculation or alternate load sizing method.
        For example, if the ductless equipment is providing only supplemental heating or cooling to a home with a central ducted system,
        sizing to loads smaller than those from Manual J would make sense.
        ...
        Factor in supplemental heating or cooling from other equipment if applicable. ACCA’s Manual S can also be used to help select the right heat pump.
        </Collapsible>
    ...
    <Tab eventKey="installation" title="Installation">
        ...
        <PhotoInput id="vacuum_decay_test_results_photo" label="Vacuum Decay Test Results – Photo">
            ...
            The system must be isolated from the vacuum pump. The vacuum must not rise above 500 microns in 15 minutes.
