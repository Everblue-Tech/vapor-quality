...
checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(
        ({ stats, previousFileSizes, warnings }) => {
            ...
            // load ES modules using import(). Minimal changes were made here to support an
            // asyncronous configFactory function. Namely, the following section of code is executed
            // inside a callback
            configFactory('production').then(config => {
...
// PNNL has modified webpack.config.js to make configFactory asycronous so it can
// load ES modules using import(). Minimal changes were made here to support an
// asyncronous configFactory function. Namely, made build() async and added the line
// to await a call to configFactory.
